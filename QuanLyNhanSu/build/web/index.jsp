    ...
    <body>
        ...
        <div class="header-w3l">
            ...
            <% User add = (User) request.getAttribute("add");
                if (add != null) {%>
            <div>
                <p style="color:red;"><span style="margin-left:60px;">Chúc Mừng Đăng Ký Tài Khoản <%=add.getUsername()%> Thành công</span></p>
            </div> 
            <% }%>
            <% User error = (User) request.getAttribute("err");
                if (error != null) {%>
            <div>
                <p style="color:red;"><span style="margin-left:60px;">Tài khoản <%=error.getUsername()%> Đã Tồn Tại</span></p>
            </div> 
            <% }%>
        </div>
        <!--//header-->
        <!--main-->
        <div id="class_login_hide" class="main-w3layouts-agileinfo" style="position: absolute;margin-left: 421px;display:none;" >
