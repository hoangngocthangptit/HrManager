            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <section id="main-content" style="padding-top: 39px;">
                    ...
                    <div>
                        ...
                        <span><a href=""><i style="opacity:0.7;line-height: 51px;margin-left: 13px;" class="fas fa-search"></i></a><input  style="color:white;opacity:0.7;width:257px;border-radius:14px;background-color: rgba(0, 0, 0, 0);position: absolute;padding-left: 16px;margin-top: 23px;" type="text" placeholder="Tìm Kiếm Theo Tên" /></span>
                    </div>
...
nv.
                            <td>
                                <a href="/QuanLyNhanSu/XuLiXoa?id=<%=nv.getEmployee_ID()%>" id="xoa" onclick=""><i class="fas fa-user-slash" style="border: 1px solid white;border-radius: 5px;">Xóa</i></a>
                            </td>
                        </tr>
                        <%
                            }
