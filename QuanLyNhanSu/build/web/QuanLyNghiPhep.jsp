...
<html>
    <head>
        ...
        <title>Quản Lý Ngày Nghỉ Của Nhân Viên</title>
        <!-- javascripts -->
    ...
    <body style="background: url(images/bann.jpg) fixed;font-size: 14px !important;">
        <section id="container" class="">
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <%
                                    ...
                                    if (sua != null) {
                                %>
                                <i class="far fa-smile-beam" style="color:red;margin-right: 6px;"></i><span style="color:red;"><%out.print(sua); %></span>
                                    <%
                                        }
                                    %>
                            </div>
                ...
                <div>
                    <i class="fas fa-temperature-high">Quản Lý Nghỉ Phép</i>
                ...
                <div>
                    <table id="bang">
                        ...
                        <tr>
                            <td><%=count%></td>
                            <td><%=e.getLast_Name() +" "+ e.getFrist_Name()%></td>
                            <td><%=e.getSSN()%></td>
                            <td><%=e.getVacation_Days()%></td>
                            <td><form action="XuLyNgayNghi" method="GET"><i class="fas fa-wrench">Sửa Ngày Nghỉ</i>
                                    <input type="number" name="ngaynghi" placeholder="Nhập Số" required="">
                                    <input type="hidden" name="Employee_ID" value="<%=e.getEmolyee_id()%>">
