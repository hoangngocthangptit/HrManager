        ...
        <section id="container" class="">
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <section id="main-content" style="padding-top: 39px;">
                    ...
                    <div>
                        <a href=""><i class="fas fa-birthday-cake">Quản Lý Sinh Nhật</i></a>
                    ...
                    <div>
                        ...
                        <%
                            ...
                            for (NhanVienChinhThuc nv : PersonalDAO.getNhanVienChinhThuc()) {
                                ...
                                Long ngaySN = Math.abs(d2.getTime() - d1.getTime()) / (24 * 60 * 60 * 1000);
                                count++;
