        ...
        <section id="container" class="">
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <section id="main-content" style="padding-top: 39px;">
                    ...
                    <div>
                        <a href="TaoHoSoNhanVien.jsp"><i class="far fa-address-card">Quản Lý Kỷ Niệm Vào Làm</i></a>
                        <span id="Searchhhh"><a href=""><i style=" opacity:0.7;" class="fas fa-search"></i></a><input style="color:red;opacity:0.7;width:257px;border-radius:14px;background-color: rgba(0, 0, 0, 0); margin-top: 11px;;position: absolute;" type="text" placeholder="Tìm Kiếm Theo Tên" /></span>
                    </div>
                    ...
                    <div>
                        <table id="bang">
                            <tr>
                                ...
                                <th>Email</th>
                                <th>Ngày Bắt Đầu</th>
                                <th>Còn Cách Kỷ Niệm Ngày Làm Đầu Tiên?</th>
                            </tr>
                        <%
                            int count = 0;
                            ...
                            for (NhanVienChinhThuc nv : PersonalDAO.getNhanVienChinhThuc()) {
                                String s = nv.getHire_Date();
                                Date d2 = new SimpleDateFormat("dd-MM").parse(s);
                                Long ngaydau = Math.abs(d2.getTime() - d1.getTime()) / (24 * 60 * 60 * 1000);
